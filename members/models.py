...
class Group(models.Model):
    ...
    discordGroup = models.CharField(max_length=250, verbose_name="Discord Group ID", null=True)
    discordChannel = models.CharField(max_length=250, verbose_name="Discord Channel ID", null=True)
