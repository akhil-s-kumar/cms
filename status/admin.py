...
class ThreadAdmin(ImportExportModelAdmin, ExportActionMixin, admin.ModelAdmin):
    fieldsets = (
        (None, {
            'fields': ('name', 'isActive', 'enableDiscordGroupNotification', 'enableTelegramGroupNotification', 'allowBotToKick', 'noOfDays')
        }),
        ('Timings', {
    ...
    list_display = ('name', 'isActive', 'enableDiscordGroupNotification', 'enableTelegramGroupNotification', 'allowBotToKick', 'generationTime', 'dueTime', 'logTime')
    search_fields = ['name']
